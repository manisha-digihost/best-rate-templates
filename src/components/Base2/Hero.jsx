      ...
      >
          ...
          >
            <Container className="h-100 d-flex align-items-center justify-content-center text-center">
              <div className="carousel-content animate__animated animate__fadeInUp">
                <h1 className="display-4 fw-bold text-primary mb-4">Welcome to Best Rate</h1>
                <p className="lead mb-4">Providing the best financial solutions for your business growth</p>
        ...
        <Carousel.Item>
          ...
          >
            <Container className="h-100 d-flex align-items-center justify-content-center text-center">
              <div className="carousel-content animate__animated animate__fadeInUp">
                <h1 className="display-4 fw-bold text-primary mb-4">Professional Financial Services</h1>
                <p className="lead mb-4">Expert guidance to help you achieve your financial goals</p>
        ...
        <Carousel.Item>
          ...
          >
            <Container className="h-100 d-flex align-items-center justify-content-center text-center">
              <div className="carousel-content animate__animated animate__fadeInUp">
                <h1 className="display-4 fw-bold text-primary mb-4">Trusted by Thousands</h1>
                <p className="lead mb-4">Join our satisfied clients and experience excellence in service</p>
