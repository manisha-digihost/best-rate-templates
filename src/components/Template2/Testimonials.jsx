                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} >
                    <div style={{backgroundColor:"#fff",padding:"20px"}}>
                      ...
                      <h3 className="mb-2" style={{fontSize:"20px",textAlign:"center"}}>{testimonial.name}</h3>
            ...
            <div className="slider slider-nav mt-4">
              <Slider {...settingsNav} ref={sliderNavRef}>
                {testimonials.map((testimonial, index) => (
                  <div key={index} >
                      <figure style={{display:"flex",justifyContent:"center"}}>
                         <img style={{borderRadius:"50%",height:"70px",width:"70px",overflow:"hidden",background:"#fff",padding:"10px"}} src="data:image/png;base64," alt="" />
                      </figure>
